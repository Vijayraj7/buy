<template>
    ...
    >
        ...
        <div class="flex justify-end 2xl:justify-between items-center gap-4 w-full">
            <!-- search box -->
            <form
                @submit.prevent="goToSearch"
                class="grow w-auto h-12 rounded-lg hidden 2xl:flex justify-between items-center overflow-hidden"
            >
                <input
                    type="search"
                    name="search"
                    class="form-control grow h-full inline-block p-6 pr-2 placeholder:text-gray-300  text-base font-normal font-['Lato'] leading-normal outline-none bg-white/10 text-white"
                    :placeholder="$t('Search for products') + '...'"
                />
                <button type="submit" class="h-full w-10 bg-white/10">
            ...
            <button
                ...
                class="h-8 w-8 2xl:h-10 2xl:w-10 bg-white/10 flex 2xl:hidden justify-center items-center rounded"
            >
                <SearchIcon colorClass="text-white" />
            </button>
            ...
            <button
                ...
                class="px-4 py-2 md:px-6 md:py-3 bg-primary text-white text-sm md:text-base rounded-lg duration-150 hover:bg-primary-700 hidden lg:block"
            >
                Login
            </button>
            ...
            <ul v-if="AuthStore.user" class="hidden lg:flex items-center gap-4">
                <RouterLink to="/wishlist" class="relative">
                    ...
                    <div
                        class="absolute -top-2.5 -right-2 w-3.5 h-3.5 bg-green-500 rounded-2xl outline outline-1 outline-white inline-flex flex-col justify-center items-center gap-1.5 text-white text-[8.53px] font-bold leading-3"
                    >
                ...
                >
                    <Cart2 colorClass="text-primary" height="24" width="30" />
            ...
            <button
                type="button"
                class="flex lg:hidden justify-center items-center h-8 w-8 bg-white/10 rounded"
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="h-full bg-white shadow-xl p-4">
                                    ...
                                    >
                                        <div
                                            class="text-primary-600 text-lg font-bold leading-normal tracking-tight font-['Roboto']"
                                        >
                                            {{ $t("Menu") }}
                                        </div>
