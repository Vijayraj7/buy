<template>
    <div class="shopCard">
        ...
        <div class="shopCard__content">
            <div class="w-full flex flex-col lg:flex-row justify-start items-start lg:items-center gap-2">
                <div
                    class="w-16 h-16 lg:w-20 lg:h-20 relative bg-white rounded-[500px] overflow-hidden"
                >
                    <img
                ...
                <div
                    class="flex-1 inline-flex flex-col justify-start items-start gap-2 w-full"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            <router-link
                                ...
                                class="justify-start text-white text-lg font-medium leading-relaxed"
                            >
                                {{ shop?.name }}
                            </router-link>
                        </div>
                    ...
                    <div
                        class="self-stretch inline-flex flex-col lg:flex-row justify-start items-start gap-2"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <StarIcon
                                            class="w-[16px] text-warning"
                                        />
                                        <div
                                            class="justify-start text-white text-xs font-semibold leading-tight"
                                        >
                        ...
                        <RouterLink :to="`/shops/${props.shop?.id}`" class="flex justify-start items-center gap-2">
                            <div
                                class="justify-start text-blue-400 text-sm font-normal leading-snug"
                            >
                                {{ $t("Visit Store") }}
                            </div>
                             <ArrowRightIcon class="w-5 h-5 text-blue-400" />
                        </RouterLink>
                    </div>
                </div>
            </div>
