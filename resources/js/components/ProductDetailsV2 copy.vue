    ...
    <div class="container-2">
        <div v-show="!isLoading" class="mb-20">
            <div class="">
                ...
                >
                    <div
                        class="w-full col-span-12 lg:col-span-7 grid grid-cols-12 gap-2 lg:gap-3"
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                <swiper-slide
                                    ...
                                    :key="thumbnail.id"
                                    class="h-full max-h-[208px] md:max-h-[308px] lg:max-h-[450px]"
                                >
                                    <div
                        ...
                        >
                            <swiper
                                ...
                                class="product-details-thumbnail max-h-[208px] lg:max-h-[450px]"
                                :direction="'vertical'"
                            >
                                <swiper-slide
                                    v-for="thumbnail in product.thumbnails"
                ...
                <div class="grid grid-cols-12 gap-[18px]">
                    ...
                    <div class="col-span-12 lg:col-span-8">
                        ...
                        <div
                            v-if="aboutProduct"
                            class="description px-4 lg:px-0"
                        >
                            <div
...
import ShopCardTopV2 from "./ShopCardTopV2.vue";
import ShopCardTopV2Small from "./ShopCardTopV2Small.vue";
import ReviewV2 from "./ReviewV2.vue";
import ProductCardHorizontalV2 from "./ProductCardHorizontalV2.vue";
import SectionContainer from "./SectionContainer.vue";
import ViewAllBtn from "./ViewAllBtn.vue";
import ProductCardV2 from "./ProductCardV2.vue";
...
.product-details-thumbnail .swiper-slide {
    @apply w-full h-12 md:w-full md:h-40 cursor-pointer transition-all duration-200;
}
...
.product-details-thumbnail .swiper-slide-thumb-active {
    @apply outline outline-2 outline-offset-[-2px] outline-blue-500  w-full h-14 md:w-full md:h-40;
}
</style>
