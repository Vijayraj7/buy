                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-[24px] lg:pb-[32px] pt-6">
                    ...
                    <div class="w-full px-4 lg:pl-0 2xl:px-0">
                        ...
                        <div class="flex items-center gap-2 mt-4 flex-wrap">
                            <!-- discount Price -->
                            <div class="text-primary-500 text-[26px] lg:text-3xl font-bold leading-10">
                                {{
                        ...
                        <div
                            ...
                            <div class="ml-auto flex justify-center items-center gap-4">
                                <!-- Share -->
                                ...
                                <button class="bg-white/10 rounded-full w-8 h-8 flex justify-center items-center"
                                    ...
                                    <RiHeart3Line v-if="!product.is_favorite" class="w-[22px] h-[22px] text-zinc-900" />
                        ...
                        <div v-if="cartProduct"
                            ...
                            <div class="p-1 rounded-[10px] border border-slate-200 inline-flex gap-2 bg-white">
                    ...
                    <div class="col-span-12 lg:col-span-8">
                        ...
                        <div v-if="review" class="px-4 lg:px-0">
                            ...
                            <div class="mt-[15px] mb-[32px]">
                                ...
                                <div class="space-y-6">
                                    <ReviewV4 v-for="review in reviews" :key="review.id" :review="review" />
                                </div>
                        ...
                        <!-- shop section  -->
                        <div class="p-4 sticky top-40 rounded-xl grid grid-cols-8 gap-4 bg-neutral-100 ">
